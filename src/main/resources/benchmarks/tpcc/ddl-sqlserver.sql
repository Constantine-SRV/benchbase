...
CREATE TABLE [dbo].[WAREHOUSE](
	...
	PRIMARY KEY (W_ID) WITH (DATA_COMPRESSION = PAGE)
...
CREATE TABLE [dbo].[STOCK](
	...
	PRIMARY KEY (S_W_ID,S_I_ID) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [dbo].[ORDER_LINE](
	...
	PRIMARY KEY (OL_W_ID,OL_D_ID,OL_O_ID,OL_NUMBER) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [dbo].[OORDER](
	...
	PRIMARY KEY (O_W_ID,O_D_ID,O_ID) WITH (DATA_COMPRESSION = PAGE),
    UNIQUE (O_W_ID,O_D_ID,O_C_ID,O_ID) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [dbo].[NEW_ORDER](
	...
	PRIMARY KEY (NO_W_ID,NO_D_ID,NO_O_ID) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [dbo].[ITEM](
	...
	PRIMARY KEY (I_ID) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [dbo].[DISTRICT](
	...
	PRIMARY KEY (D_W_ID,D_ID) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [dbo].[CUSTOMER](
	...
	PRIMARY KEY (C_W_ID,C_D_ID,C_ID) WITH (DATA_COMPRESSION = PAGE)
) WITH (DATA_COMPRESSION = PAGE);
